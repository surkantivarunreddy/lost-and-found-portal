...
public class MessageDto {
    ...
    // ── Send Request ──────────────────────────────────────────
    // Note: for image uploads use the multipart endpoint instead.
    // This DTO is used for plain-text messages sent as JSON.
    public static class SendRequest {

        // Optional when sending an image-only message via multipart endpoint
    ...
    public static class Response {
        ...
        private String imageUrl;   // Cloudinary URL (null for text-only messages)
